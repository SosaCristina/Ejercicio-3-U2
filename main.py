...
if __name__=="__main__":
    ...
    archivo=open("C:\\Users\\chili\\POO archivos\\Registro.csv")
    ...
    while opcion!=4:
        ...
        if opcion==1:
            ...
            for i in range (2):
                for j in range (3):
                    if(float(matriz[i][j].Getpresion())>float(maxp)):
            ...
            for i in range (2):                
                for j in range (3):
                    ...
                    if(float(matriz[i][j].Gettemperatura())<float(mint)):
            ...
            for i in range (2):
                for j in range (3):
                    if(float(matriz[i][j].Gethumedad())<float(minh)):
            ...
            for i in range (2):
                for j in range (3):
                    if(float(matriz[i][j].Getpresion())<float(minp)):
